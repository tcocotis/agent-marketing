...
- **Input:** Content brief (topic, key message, tone notes, links)
- **Output:** Three platform-specific captions with hashtags, character count checks, and any graphic adaptation flags
...
- **Input:** CoStar lead row (property address, type, listing date, agent name, email)
- **Output:** Validated, formatted lead record with personalization context
- **Model:** Claude Haiku (cost-efficient for high-volume processing)

**Reply Classifier**
- **Prompt file:** `prompts/program2-reply-classifier.md`
- **Input:** Incoming email reply text
- **Output:** Classification label + routing instruction + optional draft response
- **Model:** Claude Sonnet

**Weekly Report**
- **Prompt file:** `prompts/program2-weekly-report.md`
- **Input:** Campaign metrics data from Levitate
- **Output:** Formatted performance summary with commentary
- **Model:** Claude Sonnet
